...
export default {
  ...
  created() {
    ...
    // 镜片详情
    axios.post('https://from2121.com:8443/lens/detail',{
      lensID: this.lensID
    }).then(response => {
    ...
    // 镜片库存列表
    axios.post('https://from2121.com:8443/lensstock/list',{
      userID: this.lensID,
    ...
    // 镜片库存总数
    axios.post('https://from2121.com:8443/lensstock/total',{
      lensID: this.lensID
    }).then(response => {
    ...
    // axios.post('https://from2121.com:8443/lens/cyl',{
    //   lensID: lensID
    // }).then(response => {
  ...
  methods: {
    ...
    handleAddStock() {
      ...
      axios.post('https://from2121.com:8443/lensstock/add', {
        stockID: stockID,
        lensID: this.lensID,
    ...
    // 保存编辑
    handleUpdateStock(){
      axios.post('https://from2121.com:8443/lensstock/update', {
    ...
    handleDelete(index, row) {
      this.$confirm('此操作将永久删除该镜片库存, 是否继续?', '提示', {
        ...
        axios.post('https://from2121.com:8443/lensstock/delete',{
