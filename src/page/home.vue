...
export default {
  ...
  created() {
    ...
    // 待办预警
    axios.post('https://from2121:8443/order/pending')
      .then(response => {
    ...
    // 今日交易看板
    axios.post('https://from2121:8443/order/transaction')
    .then(response => {
    ...
    // 库存预警
    axios.post('https://from2121:8443/spec/warning')
      .then(response => {
    ...
    // 商品概览
    axios.post('https://from2121:8443/product/overview')
      .then(response => {
    ...
    // 镜框概览
    axios.post('https://from2121:8443/frame/overview')
      .then(response => {
  ...
  mounted() {
    ...
    // 订单统计
    axios.post('https://from2121:8443/order/statistics')
      .then(response => {
