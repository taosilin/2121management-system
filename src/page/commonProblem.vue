...
export default {
  ...
  created() {
    axios.post('https://from2121.com:8443/problem/list',{
    ...
    axios.post('https://from2121.com:8443/problem/total')
    .then(response => {
  ...
  methods: {
    ...
    handleAddProblem(formName){
      this.$refs[formName].validate((valid) => {
        if (valid) {
          axios.post('https://from2121.com:8443/problem/add',{
    ...
    // 提交编辑问题
    handleUpdateProblem() {
      axios.post('https://from2121.com:8443/problem/update',{
    ...
    handleDelete(index, row) {
      this.$confirm('此操作将永久删除该问题, 是否继续?', '提示', {
        ...
        axios.post('https://from2121.com:8443/problem/delete',{
