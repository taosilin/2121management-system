...
export default {
  ...
  created() {
    axios.post('https://from2121.com:8443/comment/all',{
    ...
    axios.post('https://from2121.com:8443/comment/total')
    .then(response => {
  ...
  methods: {
    ...
    handleReply() {
      axios.post('https://from2121.com:8443/comment/reply',{
    ...
    // 修改评论状态
    onChangeState(index) {
      axios.post('https://from2121.com:8443/comment/update',{
