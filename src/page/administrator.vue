...
export default {
  ...
  created() {
    axios.post('https://from2121.com:8443/admin/list',{
    ...
    // 管理员信息总数
    axios.post('https://from2121.com:8443/admin/total')
      .then(response => {
  ...
  methods: {
    ...
    handleAddAdmin(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          axios.post('https://from2121.com:8443/admin/add',{
    ...
    handleDelete(index, row) {
      this.$confirm('此操作将永久删除该管理员, 是否继续?', '提示', {
        ...
        axios.post('https://from2121.com:8443/admin/delete',{
