...
export default {
  ...
  created() {
    ...
    axios.post('https://from2121.com:8443/color/total')
    .then(response => {
  ...
  methods: {
    ...
    handleUploadImage(param) {
      ...
      axios.post('https://from2121.com:8443/color/uploadImage',formData)
      .then(response => {
        console.log('上传图片成功')
    ...
    handleAddColor(formName){
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          axios.post('https://from2121.com:8443/color/add',{
    ...
    // 编辑颜色
    handleEditColor(){
      axios.post('https://from2121.com:8443/color/update',{
    ...
    handleDelete(index, row){
      this.$confirm('此操作将永久删除该颜色, 是否继续?', '提示', {
        ...
        axios.post('https://from2121.com:8443/color/delete',{
